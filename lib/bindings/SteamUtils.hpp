...
public:
	...
	virtual void GetBatteryInformation(int *, bool *) = 0;
	...
	virtual void SetFocusedWindow(int, bool) = 0;
	...
	virtual void SetOverlayChatBrowserInfo(unsigned int, int, int, int, int) = 0;
	virtual void ClearOverlayChatBrowserInfo(unsigned int) = 0;
	virtual void GetOverlayChatBrowserInfo(int *, unsigned int, unsigned int *) = 0;
	...
	virtual void DispatchClearAllBrowsingData(void) = 0;
	virtual void DispatchClientSettingsChanged(void) = 0;
	virtual void DispatchClientPostMessage(char const*, char const*, char const*) = 0;
	virtual void IsSteamChinaLauncher(void) = 0;
	virtual void InitFilterText(unsigned int) = 0;
	virtual void FilterText(unsigned int, char *, unsigned int, char const*, bool) = 0;
	virtual void GetIPv6ConnectivityState(int) = 0;
	virtual void RecordSteamInterfaceCreation(char const*, char const*) = 0;
	virtual void StartRuntimeInformationGathering(void) = 0;
	virtual void GetRuntimeInformation(void) = 0;
	virtual void GetCloudGamingPlatform(void) = 0;
	virtual void BGetMacAddresses(unsigned long long *, unsigned int, unsigned int *) = 0;
	virtual void BGetDiskSerialNumber(char *, int) = 0;
	virtual void TestHTTP(char const*) = 0;
};
